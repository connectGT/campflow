...
export const SPORTS = [
  ...
  { id: "football",    name: "Football",    emoji: "activity",  seats_total: 80,  seats_per_slot: 25, coaches: 2, urgent: false, image: "/sport-football.jpg",    color: "#ff5745" },
  { id: "cricket",     name: "Cricket",     emoji: "trophy",    seats_total: 80,  seats_per_slot: 25, coaches: 2, urgent: false, image: "/sport-cricket.jpg",     color: "#ff5745" },
  { id: "basketball",  name: "Basketball",  emoji: "target",    seats_total: 40,  seats_per_slot: 15, coaches: 2, urgent: false, image: "/sport-basketball.jpg",  color: "#ffb4a9" },
  { id: "badminton",   name: "Badminton",   emoji: "zap",       seats_total: 20,  seats_per_slot: 10, coaches: 1, urgent: true,  urgent_note: "Only 20 seats total — fills fast", image: "/sport-badminton.jpg",   color: "#5ed9d6" },
  { id: "self_defence",name: "Self-Defence",emoji: "shield",    seats_total: 20,  seats_per_slot: 10, coaches: 1, urgent: true,  urgent_note: "Only 20 seats total — fills fast", image: "/sport-self-defence.png", color: "#ff8a7d" },
];
